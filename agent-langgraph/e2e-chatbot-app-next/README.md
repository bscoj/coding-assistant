...
3. **Start the application**:
   ...
   The app starts on [localhost:3002](http://localhost:3002) (frontend) and [localhost:3001](http://localhost:3001) (backend)
...
2. **Set up environment variables**:
   ...
   For local proxy mode against the `agent-langgraph` backend, these local defaults are recommended:
...
3. **Run the application**:
   ...
   The app starts on [localhost:3002](http://localhost:3002)
